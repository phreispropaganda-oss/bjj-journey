...
function LoginPageContent() {
  ...
  const [error, setError] = useState(
    ...
    urlError === 'oauth_failed' ? 'Erro ao conectar com Google. Tente novamente.' : ''
  )
      ...
      <div className="w-full max-w-sm">
        ...
        {sent ? (
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            {/* Google OAuth via Route Handler — avoids PKCE cookie loss from Server Action + redirect() */}
            <a
              href="/api/auth/google"
              className="w-full flex items-center justify-center gap-3 border-[1.5px] border-[#DDD8D0] rounded-full py-3 font-semibold text-sm mb-4 hover:bg-[#F7F4F0] transition-colors"
            >
