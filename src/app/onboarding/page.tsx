            ...
            <div className="space-y-2 mb-6">
              {BELTS.map(b => (
                ...
                >
                  ...
                  {beltId === b.id && <span className="text-rise font-black">✓</span>}
                </div>
              ))}
            </div>
          </div>
        ...
        {step === 3 && (
          <div style={{ animation: 'fadeUp .25s ease' }}>
            ...
            <div className="flex items-center gap-2 bg-brand-surface rounded-2xl p-3 mb-6 border border-brand-elev">
              ...
              <span className="text-sm font-bold text-ink-secondary">Faixa {belt.name}, {degrees}° grau</span>
            </div>
              ...
              <div className="space-y-2">
                {PRACTICE_TIMES.map(p => (
                  ...
                  >
                    ...
                    {practiceTime === p.value && <span className="text-rise font-black">✓</span>}
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="bg-brand-surface border-t border-brand-elev px-5 py-4">
        ...
        {step === TOTAL_STEPS && (
          <button
            onClick={finish}
            disabled={saving}
            className="w-full text-center text-sm text-ink-muted mt-3 font-medium"
          >
